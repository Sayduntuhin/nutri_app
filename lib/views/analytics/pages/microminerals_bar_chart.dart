...
class MicromineralsBarChart extends StatefulWidget {
  const MicromineralsBarChart({super.key});

  @override
  State<MicromineralsBarChart> createState() => _MicromineralsBarChartState();
}

class _MicromineralsBarChartState extends State<MicromineralsBarChart> {
